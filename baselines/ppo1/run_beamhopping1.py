...
def main():
    ...
    if ON_TRAIN:
        ...
        U.load_variables('saved_networks1/save1-8000.m')
        ...
        while True:
            ...
            ob, rew, done, cumul_time, throughput, Data1, Time1 = env.step(action)
            ...
            # ob, rew, done, cumul_time, throughput, Data1, Time1 = env.step(action_GA)
            import copy
